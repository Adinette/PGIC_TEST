    ...
    <section>
            <div class="container flex flex-col items-center p-6 my-8 mx-auto text-center  bg-slate-100">
                ...
                <div class="flex  mt-5 text-base items-center font-semibold ">
                    <a rel="noopener noreferrer" href="#" title="Email" class="dark:text-green-700 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                            <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                            <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                        </svg>
                    </a>
                    <a rel="noopener noreferrer" href="#" title="Twitter" class="dark:text-green-700 mr-2">
                    ...
                    <a rel="noopener noreferrer" href="#" title="LinkedIn" class="dark:text-green-700 mr-2 ">
                    ...
                    <a rel="noopener noreferrer" href="#" title="GitHub" class="dark:text-green-700 mr-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-5 h-5">
                            <path
