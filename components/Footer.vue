<template>
	<footer class="p-6 dark:bg-black dark:text-gray-100">
		<div class="container grid grid-cols-2 mx-auto gap-x-3 pt-6 pb-12 sm:grid-cols-3 md:grid-cols-4 border-b border-b-white">
			<div class="flex flex-col ">
				...
				<div class="flex flex-col mt-5 text-base dark:text-gray-400">
					<a rel="noopener noreferrer" class="flex text-white" href="#">
					...
					<a rel="noopener noreferrer" class="flex my-4 text-white" href="#">
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
							class="bi bi-telephone mr-2" viewBox="0 0 16 16">
							<path
								d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.6 17.6 0 0 0 4.168 6.608 17.6 17.6 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.68.68 0 0 0-.58-.122l-2.19.547a1.75 1.75 0 0 1-1.657-.459L5.482 8.062a1.75 1.75 0 0 1-.46-1.657l.548-2.19a.68.68 0 0 0-.122-.58zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z" />
						</svg>
						zogbodomey@mairie.bj
					</a>
					<div class="flex items-center font-semibold ">
						<a rel="noopener noreferrer" href="#" title="Email" class="dark:text-white mr-2">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
								<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
								<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
							</svg>
						</a>
						<a rel="noopener noreferrer" href="#" title="Twitter" class="dark:text-white mr-2">
						...
						<a rel="noopener noreferrer" href="#" title="LinkedIn" class="dark:text-white mr-2 ">
						...
						<a rel="noopener noreferrer" href="#" title="GitHub" class="dark:text-white mr-2 ">
							<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" class="w-5 h-5">
								<path
			...
			<div class="flex flex-col ">
				<h2 class="font-bold text-xl ml-4">Liens utiles</h2>
				<div class="flex flex-col my-4 text-sm dark:text-gray-400">
					<a rel="noopener noreferrer" class="flex items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg"
							width="45" height="45" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
							<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3" />
			...
			<div class="flex flex-col ">
				<h2 class="font-bold text-xl ml-4">Zogbodomey</h2>
				<div class="flex flex-col my-4 text-sm dark:text-gray-400">
					<a rel="noopener noreferrer" class="flex items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg"
							width="45" height="45" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
							<path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3" />
		...
		<div class="flex items-center justify-center px-6 pt-8 text-sm ">
			<span class="dark:text-white">© Copyright 1986. All Rights Reserved.</span>
			<span class="text-amber-500 text-base ml-6 ">Mentions légales</span>
		</div>
	</footer>
	<div><img src="~/assets/images/home/footer.png"></div>
</template>