...
Profitez de nos services de qualité, et explorez un environnement sain!</p>
<div class="flex justify-between  mt-8 space-x-2 ">
                    <a rel="noopener noreferrer" href="#"
                        class="px-6 py-2 text-base font-semibold rounded dark:bg-amber-500 dark:text-black">EN SAVOIR PLUS</a>
                </div>
			</div>
		</div>
    </section>
